...
function App() {
  ...
  // NAME & PET SELECTION SCREEN
  if (!profile?.name_chosen) {
    return (
      <div style={{minHeight:'100vh',background:'linear-gradient(135deg,#667eea 0%,#764ba2 100%)',padding:'20px',display:'flex',justifyContent:'center',alignItems:'center'}}>
        <div style={{background:'white',borderRadius:'30px',padding:'50px',maxWidth:'550px',width:'100%',boxShadow:'0 25px 80px rgba(0,0,0,0.3)',textAlign:'center'}}>
          <div style={{fontSize:'80px',marginBottom:'20px'}}>🎮</div>
        ...
        <div style={{background:'rgba(255,255,255,0.98)',borderRadius:'25px',padding:'30px',boxShadow:'0 15px 50px rgba(0,0,0,0.3)'}}>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',flexWrap:'wrap',gap:'15px'}}>
            <div style={{display:'flex',alignItems:'center',gap:'15px'}}>
              ...
              <div style={{fontSize:'32px'}}>{profile?.pet}</div>
              <span style={{fontSize:'18px',fontWeight:'600',color:'#333'}}>{profile?.display_name}</span>
            </div>
