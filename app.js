...
function App() {
      ...
      const moveInterval = setInterval(() => {
        setFallingItems(prev => {
          ...
          if (fallen.length > 0) {
            ...
            // Play miss sound
            new Audio('data:audio/wav;base64,UklGRhIAAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQA=').play().catch(()=>{});
          }
  ...
  const catchItem = (itemId) => {
    ...
    // Play catch sound
    new Audio('data:audio/wav;base64,')]).play().catch(()=>{});
  };
  ...
  const startHunt = async () => {
    ...
    const { data, error } = await supabaseClient.from('hunts').update({ hunt_started: true }).eq('id', activeHunt.id).select().single();
    if (!error && data) {
      setActiveHunt(data);
  ...
  return (
    <div style={{minHeight:'100vh',background:'linear-gradient(135deg,#667eea 0%,#764ba2 100%)',padding:'20px'}}>
      ...
      <div style={{maxWidth:'1000px',margin:'0 auto'}}>
        ...
        ):!activeHunt.hunt_started && !playerInLobby?(
          <div style={{background:'rgba(255,255,255,0.98)',borderRadius:'25px',padding:'60px 40px',boxShadow:'0 15px 50px rgba(0,0,0,0.3)',textAlign:'center'}}>
