...
const CLUES = [
  { id: 1, clue: "Pucks fly at me all day, but I never score — I only stop the goals.", answer: "Hockey net" },
  { id: 2, clue: "Fake winter lives at my feet, smooth and white so shots glide fast.", answer: "Shooting tiles / fake ice" },
  { id: 3, clue: "I move when you pedal but never leave the room.", answer: "Stationary bike" },
  { id: 4, clue: "Hex‑shaped iron sleeps on my shelves, waiting to be lifted.", answer: "Dumbbell rack" },
  { id: 5, clue: "I'm a blue sphere too big for most games, but perfect for balance.", answer: "Blue exercise ball" },
  { id: 6, clue: "My number says 24, and jumping on me is the whole point.", answer: "24\" plyo box" },
  { id: 7, clue: "Long wooden soldiers lean quietly against the wall after practice.", answer: "Hockey sticks" },
  { id: 8, clue: "I look like a seat, but people lie on me to push heavy things.", answer: "Workout bench" },
  { id: 9, clue: "Giant bags of gear rest high above the gym floor.", answer: "Duffel bags/shelf" },
  { id: 10, clue: "The biggest screen in the house watches every workout.", answer: "Large TV" },
  { id: 11, clue: "Bright red and loud in color, I promise your clothes come out clean.", answer: "Red detergent jug" },
  { id: 12, clue: "Two machines stacked like bunk beds spin shirts into submission.", answer: "Washer/dryer stack" },
  { id: 13, clue: "I unfold like wings and hold wet clothes in the air.", answer: "Drying rack" },
  { id: 14, clue: "Not for dishes — this sink belongs to socks and sweat.", answer: "Laundry sink" },
  { id: 15, clue: "Clean piles rise and fall here like a fabric mountain range.", answer: "Laundry baskets/pile area" },
  { id: 16, clue: "A half‑moon sunrise is carved into my window.", answer: "Front door with half‑moon window" },
  { id: 17, clue: "When storms arrive, spears of fabric wait upright inside me.", answer: "Umbrella stand" },
  { id: 18, clue: "Snowy boots confess their mess inside my shallow tray.", answer: "Boot tray" },
  { id: 19, clue: "A narrow landing spot catches keys, mail, and random junk.", answer: "Entry table" },
  { id: 20, clue: "Numbers replace keys when you press my glowing buttons.", answer: "Keypad lock" },
  { id: 21, clue: "Painted mint like toothpaste, tall doors hide coats and clutter.", answer: "Mint green cabinets" },
  { id: 22, clue: "Tired legs rest here while laces get tied.", answer: "Bench" },
  { id: 23, clue: "Winter hands disappear into the cubby below.", answer: "Under‑bench glove/hat cubby" },
  { id: 24, clue: "Pairs line up neatly on racks like soldiers at inspection.", answer: "Shoe shelves" },
  { id: 25, clue: "Where order gives up — some shoes behave, the rest rebel on the floor.", answer: "Shoe pile" },
  { id: 26, clue: "One wall looks like a jungle instead of paint.", answer: "Tropical wallpaper" },
  { id: 27, clue: "Flames live here only in imagination — white bricks, zero heat.", answer: "White brick fireplace" },
  { id: 28, clue: "Woven strands hold blankets for movie nights.", answer: "Blanket basket" },
  { id: 29, clue: "A tiny chest sits closed, guarding nothing but decoration.", answer: "Small treasure chest" },
  { id: 30, clue: "Long white doors trimmed with gold hide quiet storage.", answer: "White cabinets with gold handles" },
  { id: 31, clue: "A couch so big it could swallow the whole family at once.", answer: "Sectional couch" },
  { id: 32, clue: "Controllers wait here for the next game to begin.", answer: "Game controllers" },
  { id: 33, clue: "Blue and white tiles form a tiny café table beside the backyard light.", answer: "Mosaic round table" },
  { id: 34, clue: "Two dark chairs face each other like they're mid‑conversation.", answer: "Dark chairs" },
  { id: 35, clue: "Tall and skinny, I stretch upward like a green antenna.", answer: "Tall skinny plant" },
  { id: 36, clue: "Thick upright leaves grow straight like swords from the soil.", answer: "Snake plant" },
  { id: 37, clue: "I'm the only plant that never touches the ground, dangling from above.", answer: "Hanging plant" },
  { id: 38, clue: "If you ever need me, something has already gone wrong — red and ready.", answer: "Fire extinguisher" },
  { id: 39, clue: "Wet footprints end where this dark mat begins.", answer: "Black floor mat" },
  { id: 40, clue: "Covered in magnets and papers, I guard everything cold.", answer: "Fridge/freezer" },
  { id: 41, clue: "Once a tree, now the center of every meal and conversation.", answer: "Tree‑trunk island" },
  { id: 42, clue: "Square holes beneath me cradle bottles like a puzzle grid.", answer: "Wine rack under island" },
  { id: 43, clue: "Deep and wide, I swallow pots that normal sinks can't handle.", answer: "Farmhouse sink" },
  { id: 44, clue: "A metal canopy hovers above the heat and steam.", answer: "Range hood" },
  { id: 45, clue: "I whistle when water boils for tea.", answer: "Kettle" },
  { id: 46, clue: "Beans go in, caffeine comes out.", answer: "Coffee machine" },
  { id: 47, clue: "Loud and crunchy, I crush beans before brewing.", answer: "Coffee grinder" },
  { id: 48, clue: "Hidden low in the cabinets, leftovers spin in my glow.", answer: "Built‑in microwave" },
  { id: 49, clue: "Trash disappears when this drawer slides shut.", answer: "Pull‑out garbage drawer" },
  { id: 50, clue: "Hands and numbers spin around my face all day long.", answer: "Kitchen clock" },
  { id: 51, clue: "Snacks climb from floor to ceiling inside this towering cupboard.", answer: "Tall pantry cupboard" },
  { id: 52, clue: "Cardboard mornings filled with flakes wait on one of these shelves.", answer: "Cereal box" },
  { id: 53, clue: "Cuts and headaches are treated where tiny boxes and bottles gather.", answer: "Medical cabinet" },
  { id: 54, clue: "Small fizzy cans hide here among the medicine and supplies.", answer: "Bubly cans" },
  { id: 55, clue: "Trains race across maps inside this cardboard adventure.", answer: "Ticket to Ride" },
  { id: 56, clue: "Armies conquer the world across another game board nearby.", answer: "Risk" },
  { id: 57, clue: "Three big letters on a wall quietly spell three siblings.", answer: "LEW letters" },
  { id: 58, clue: "Soft and black, I warm cold feet after a shower.", answer: "Black bath mat" },
  { id: 59, clue: "Clear walls keep splashes trapped inside while water falls.", answer: "Glass shower" },
  { id: 60, clue: "Gold patterns cover the walls around a dark faucet and a single throne.", answer: "Gold wallpaper bathroom" }
];
...
function App() {
  ...
  // Mini-game: Start when hunt exists but not started
  useEffect(() => {
    if (activeHunt && !activeHunt.hunt_started && !isAdmin && !wantsToJoin) {
      setGameActive(true);
  ...
  }, [activeHunt, isAdmin, wantsToJoin]);
  ...
  const startHunt = async () => {
    ...
    if (!error) setActiveHunt({ ...activeHunt, hunt_started: true });
  };
  ...
  const endHunt = async () => {
    ...
    if (confirm('End hunt for everyone?')) {
      // First clear all player names/pets
  ...
  return (
    <div style={{minHeight:'100vh',background:'linear-gradient(135deg,#667eea 0%,#764ba2 100%)',padding:'20px'}}>
      ...
      {activeHunt && !isAdmin && !playerInLobby && (
      ...
      <div style={{maxWidth:'1000px',margin:'0 auto'}}>
        ...
        ):!activeHunt.hunt_started && !wantsToJoin?(
          <div style={{background:'rgba(255,255,255,0.98)',borderRadius:'25px',padding:'60px 40px',boxShadow:'0 15px 50px rgba(0,0,0,0.3)',textAlign:'center',position:'relative',overflow:'hidden',minHeight:'500px'}}>
            <div style={{fontSize:'100px',marginBottom:'20px'}}>🎮</div>
            <h2 style={{fontSize:'32px',fontWeight:'bold',marginBottom:'10px',color:'#333'}}>Game Starting Soon!</h2>
            <p style={{fontSize:'18px',color:'#666',marginBottom:'30px'}}>Play while you wait</p>
            
            {gameActive&&<div style={{position:'relative',height:'300px',background:'linear-gradient(135deg,#e0f2fe 0%,#bae6fd 100%)',borderRadius:'20px',marginBottom:'30px',overflow:'hidden'}}>
              <div style={{position:'absolute',top:'10px',right:'10px',background:'white',padding:'10px 20px',borderRadius:'10px',fontSize:'18px',fontWeight:'bold',color:'#667eea'}}>Score: {gameScore}</div>
              {fallingItems.map(item=><div key={item.id} onClick={()=>catchItem(item.id)} style={{position:'absolute',left:`${item.x}%`,top:`${item.y}%`,fontSize:'40px',cursor:'pointer',transition:'top 0.05s linear'}}>{item.emoji}</div>)}
            </div>}
            
            <button onClick={handleJoinGame} style={{padding:'24px 60px',background:'linear-gradient(135deg,#10b981 0%,#059669 100%)',color:'white',border:'none',borderRadius:'18px',fontSize:'24px',fontWeight:'bold',cursor:'pointer',boxShadow:'0 10px 30px rgba(16,185,129,0.5)',animation:'pulse 2s infinite'}} className="pulse">🎯 JOIN GAME!</button>
            
            <style>{`@keyframes pulse { 0%, 100% { transform: scale(1); } 50% { transform: scale(1.05); } }`}</style>
          </div>
        ):!activeHunt.hunt_started?(
          <div style={{background:'rgba(255,255,255,0.98)',borderRadius:'25px',padding:'60px 40px',boxShadow:'0 15px 50px rgba(0,0,0,0.3)',textAlign:'center'}}>
            <div style={{fontSize:'100px',marginBottom:'30px'}}>⏳</div>
